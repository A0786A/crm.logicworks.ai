/*
  ...
  1. Changes
    ...
    - Copy data from employees table if it exists
...
DROP POLICY IF EXISTS "Enable full access for admins" ON agents;
DROP POLICY IF EXISTS "Enable self profile updates" ON agents;
